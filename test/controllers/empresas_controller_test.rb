...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { texto1: @empresa.texto1, texto2: @empresa.texto2, titulo1: @empresa.titulo1, titulo2: @empresa.titulo2 }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { texto1: @empresa.texto1, texto2: @empresa.texto2, titulo1: @empresa.titulo1, titulo2: @empresa.titulo2 }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
